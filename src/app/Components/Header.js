...
function Header() {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-expand-md  dark:bg-black w-full">
                <div className="container flex justify-between mx-auto px-4 sm:px-6 lg:px-10 md:px-10 md:py-4 lg:py-4">
                    ...
                    <div className="" >
                        ...
                        <label className="switch">
                            ...
                            <input onClick={toggleDarkMode} type="checkbox" className="input"/>
